 ...
 */
class PreBudgetSummaryDatatable extends BaseDatatable
{
    ...
    public function configureDataTable(array $options = array())
    {
        ...
        $this->ajax->set($this->getDefaultAjax(['url' => $this->router->generate('pre_budget_summary_list')]));

        $this->addActionButton('pre_budget_summary_update', 'Edit', 'glyphicon-edit', ['id' => 'id'], function ($row) {
        ...
        $this->addActionButton('pre_budget_summary_view', 'View', 'glyphicon-eye-open', ['id' => 'id']);
        ...
        $this->columnBuilder
            ...
            ->add('requestAmount', NumberColumn::class, array(
                ...
                'dql' => "(
                        ...
                        FROM BudgetBundle:PreBudgetSummaryDetail {budgetDetail} 
                        WHERE {budgetDetail}.budgetSummary = {prebudgetsummary}.id GROUP BY {budgetDetail}.budgetSummary)",
                'searchable' => false,
                'orderable' => false,
            ...
            ->add('nextYearProjectionAmount', NumberColumn::class, array(
                ...
                'dql' => "(
                        ...
                        FROM BudgetBundle:PreBudgetSummaryDetail {budgetDetail2} 
                        WHERE {budgetDetail2}.budgetSummary = {prebudgetsummary}.id GROUP BY {budgetDetail2}.budgetSummary)",
                'searchable' => false,
                'orderable' => false,
                'type_of_field' => 'integer',
            ))
            ->add('afterNextYearProjectionAmount', NumberColumn::class, array(
                ...
                'dql' => "(
                        ...
                        FROM BudgetBundle:PreBudgetSummaryDetail {budgetDetail3} 
                        WHERE {budgetDetail3}.budgetSummary = {prebudgetsummary}.id GROUP BY {budgetDetail3}.budgetSummary)",
                'searchable' => false,
                'orderable' => false,
                'type_of_field' => 'integer',
            ))
    ...
    {
        return 'BudgetBundle\Entity\PreBudgetSummary';
    }
