 ...
 */
class BudgetIncomeSummaryDatatable extends BaseDatatable
{
    ...
    public function configureDataTable(array $options = array())
    {
        ...
        $this->ajax->set($this->getDefaultAjax(['url' => $this->router->generate('budget_income_summary_list')]));

        $this->addActionButton('budget_income_summary_update', 'Edit', 'glyphicon-edit', ['id' => 'id'], function ($row) {
        ...
        $this->addActionButton('budget_income_summary_view', 'View', 'glyphicon-eye-open', ['id' => 'id']);
        ...
        $this->columnBuilder
            ...
            ->add('afterNextYearProjectionAmount', NumberColumn::class, array(
                ...
                'dql' => "(
                        ...
                        FROM BudgetBundle:BudgetIncomeSummaryDetail {budgetDetail3} 
                        WHERE {budgetDetail3}.budgetSummary = {budgetincomesummary}.id GROUP BY {budgetDetail3}.budgetSummary)",
                'searchable' => false,
                'orderable' => false,
                'type_of_field' => 'integer',
            ))
