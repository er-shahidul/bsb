 ...
 */
class PreBudgetSummaryDetailRepository extends BaseRepository
{
    ...
    /**
     * @param PreBudgetSummary|mixed $budget
     * @return array
     */
    public function getBudgetSummaryAmount($budget)
    {
        ...
        /** @var PreBudgetSummaryDetail $budgetDetail */
    ...
    {
        $budget = $this->_em->getRepository('BudgetBundle:PreBudgetSummary')->getPreBudgetSummaryByYear($year);
