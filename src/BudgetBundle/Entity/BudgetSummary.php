 ...
 * BudgetSummary
 *
 * @ORM\Table(name="budget_summary")
 * @ORM\Entity(repositoryClass="BudgetBundle\Repository\BudgetSummaryRepository")
 */
class BudgetSummary extends BaseWorkflowEntity
{
    /**
    ...
    /**
     * @var ArrayCollection
     * @ORM\OneToMany(targetEntity="BudgetBundle\Entity\BudgetSummaryDetail", mappedBy="budgetSummary")
     */
