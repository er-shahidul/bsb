...
/**
 * Class MicroCreditBoardMeetingDatatable
 *
 * @package BoardMeetingBundle\Datatables
 */
class MicroCreditBoardMeetingDatatable extends BaseBoardMeetingDatatable
{
    /**
     * {@inheritdoc}
     */
    public function configureDataTable(array $options = array())
    {
        ...
        $this->ajax->set($this->getDefaultAjax(['url' => $this->router->generate('board_meetings_micro_credit')]));
